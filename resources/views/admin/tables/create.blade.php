                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="post" action="{{ route('admin.tables.store') }}">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <select id="status" name="status" class="form-multiselect block w-full mt-1 rounded-lg border border-gray-400">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <select id="location" name="location" class="form-multiselect block w-full mt-1 rounded-lg border border-gray-400">
